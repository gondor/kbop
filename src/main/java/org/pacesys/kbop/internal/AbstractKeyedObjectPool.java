...
public abstract class AbstractKeyedObjectPool<K, V, E extends PoolableObject<V>> implements IKeyedObjectPool<K, V> {
   ...
   */
  @Override
  public IPooledObject<V> borrow(PoolKey<K> key) throws Exception {
	return createFuture(key).get();
  }
   ...
   */
  @Override
  public IPooledObject<V> borrow(PoolKey<K> key, long timeout, TimeUnit unit) throws TimeoutException, Exception {
	return createFuture(key).get(timeout, unit);
  }
   ...
   */
  @Override
  public void clear(PoolKey<K> key) {
